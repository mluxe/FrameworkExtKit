...
namespace FrameworkExtKit.Services.DirectoryServices {
    public class LdapDirectoryGroupService<T> : DirectoryGroupService<T> where T : DirectoryGroup {
        ...
        public LdapDirectoryGroupService(DirectoryEntry rootEntry) {
            // DirectoryAccountType = typeof(DirectoryAccount);
        ...
        public LdapDirectoryGroupService(IConfiguration configuration) { 
            this.ldapDirectoryService = new LdapDirectoryService(configuration);
            this.ldapDirectoryService.ObjectClass = this.ObjectClass;
        }

        public LdapDirectoryGroupService(IOptions<LdapSettings> ldapSettingsOptions) {
            this.ldapDirectoryService = new LdapDirectoryService(ldapSettingsOptions);

            this.ldapDirectoryService.ObjectClass = this.ObjectClass;
        }

        public LdapDirectoryGroupService(LdapSettings ldapSettings) {
