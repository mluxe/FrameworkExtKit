...
namespace FrameworkExtKit.Services.DirectoryServices {
    public class LdapDirectoryRoleAccountService<T> : DirectoryRoleAccountService<T> where T : DirectoryRoleAccount {
        ...
        public LdapDirectoryRoleAccountService(DirectoryEntry rootEntry) {
            // DirectoryAccountType = typeof(DirectoryAccount);
        ...
        public LdapDirectoryRoleAccountService(IConfiguration configuration) { 
            this.ldapDirectoryService = new LdapDirectoryService(configuration);
            this.ldapDirectoryService.ObjectClass = this.ObjectClass;
        }

        public LdapDirectoryRoleAccountService(IOptions<LdapSettings> ldapSettingsOptions) {
            this.ldapDirectoryService = new LdapDirectoryService(ldapSettingsOptions);

            this.ldapDirectoryService.ObjectClass = this.ObjectClass;
        }

        public LdapDirectoryRoleAccountService(LdapSettings ldapSettings) {
