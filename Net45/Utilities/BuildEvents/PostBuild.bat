...
:releaseBuild
    PowerShell.exe -ExecutionPolicy ByPass -File %targetScriptPath%\UpdateVersionInfo.ps1 -projectPath %projectPath% -targetDLLFullPath %dllPath% -buildConfig %buildConfig%
